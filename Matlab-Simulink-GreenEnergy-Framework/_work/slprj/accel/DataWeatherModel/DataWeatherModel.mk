...
MODEL              = DataWeatherModel
MODULES            = DataWeatherModel_acc_data.c 
MAKEFILE           = DataWeatherModel.mk
...
MASTER_ANCHOR_DIR  = 
START_DIR          = C:\Users\Oleg\Drive\Documents_Files\Projects\GreenTechonology\_work
S_FUNCTIONS        = 
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 2
...
SHARED_BIN_DIR     = 
SHARED_LIB         = 
MEX_OPT_FILE       = -f "C:\Program Files\MATLAB\MATLAB Production Server\R2015a\bin\win64\mexopts\msvc2013.xml"
COMPUTER           = PCWIN64
VISUAL_VER         = 12.0
...
MODELLIB                  = DataWeatherModellib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\accel\DataWeatherModel
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\Oleg\Drive\Documents_Files\Projects\GreenTechonology\DataWeather
