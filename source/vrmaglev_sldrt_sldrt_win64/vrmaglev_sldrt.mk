...
MODEL                := vrmaglev_sldrt
MODULES              := rtGetInf.c rtGetNaN.c rt_nonfinite.c vrmaglev_sldrt_data.c vrmaglev_sldrt_tgtconn.c
MAKEFILE             := vrmaglev_sldrt.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := vrmaglev_sldrt_ref.rsp
...
# additional includes
REQ_INCLUDES += ;C:/Users/ofcra/Documents/GreenEnergy/Matlab-Simulink-GreenEnergy-Framework;C:/Users/ofcra/Documents/GreenEnergy/Matlab-Simulink-GreenEnergy-Framework/vrmaglev_sldrt_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
